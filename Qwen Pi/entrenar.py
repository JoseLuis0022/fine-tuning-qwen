...
def main():
    overrides = {
        ...
        "save_every": 100,
        # Único cambio vs la receta de Claude Code: el dataset de Pi es ~3x más largo
        # por ejemplo (incluye los esquemas JSON de las tools en cada system block).
        # grad_checkpoint recalcula activaciones en el backward en vez de guardarlas,
        # evitando el swap que esa longitud extra provoca en 16GB de RAM.
